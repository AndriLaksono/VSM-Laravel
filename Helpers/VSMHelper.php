...
class VSMHelper
{
    ...
    */
    ...
    {
        $term           = VSMHelper::term($query, $dokumen);
        $dokumen_term   = VSMHelper::dokumen_term($dokumen);
        $df             = VSMHelper::df($term, $query, $dokumen_term);
        $idf            = VSMHelper::idf($query, $dokumen_term, $df);
        $bobot          = VSMHelper::bobot($query, $dokumen_term, $idf);
        $cos_similarity = VSMHelper::cosine_similarity($bobot);
