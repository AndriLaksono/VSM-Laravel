...
class PreprocessingHelper
{
    ...
    */
    ...
    {
        $query_case     = PreprocessingHelper::case_folding($query);
        $query_token    = PreprocessingHelper::tokenizing($query_case);
        $query_filter   = PreprocessingHelper::filtering($query_token);
        $query_dasar    = PreprocessingHelper::stemming($query_filter);
        return $query_dasar;
    }
